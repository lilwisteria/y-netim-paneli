            ...
            <form onSubmit={handleSubmit} className="coupon-form">
              <div className="form-group-row">
                <div className="form-group code-group">
                  ...
                  <div className="code-input-wrapper">
                    <input type="text" id="code" name="code" value={couponData.code} onChange={handleChange} maxLength={8} required onInvalid={(e) => e.target.setCustomValidity('Lütfen bu alanı doldurun.')} onInput={(e) => e.target.setCustomValidity('')} />
                ...
                <div className="form-group">
                  ...
                  <select id="discount_type" name="discount_type" value={couponData.discount_type || "percentage"} onChange={handleChange} required onInvalid={(e) => e.target.setCustomValidity('Lütfen bir seçenek belirleyin.')} onInput={(e) => e.target.setCustomValidity('')}>
              ...
              <div className="form-group-row form-group-row-triple">
                <div className="form-group">
                  ...
                  <input type="number" id="discount_amount" name="discount_amount" value={couponData.discount_amount} onChange={handleChange} min="0" required onInvalid={(e) => e.target.setCustomValidity('Lütfen bu alanı doldurun.')} onInput={(e) => e.target.setCustomValidity('')} />
                </div>
                <div className="form-group">
                  <label htmlFor="min_order_amount">Minimum Sipariş Tutarı</label>
                  <input type="number" id="min_order_amount" name="min_order_amount" value={couponData.min_order_amount} onChange={handleChange} min="0" required onInvalid={(e) => e.target.setCustomValidity('Lütfen bu alanı doldurun.')} onInput={(e) => e.target.setCustomValidity('')} />
                </div>
                <div className="form-group">
